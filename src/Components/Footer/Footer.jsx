...
const Footer = () => {
    return (
        <footer className="bg-[var(--primary)] text-[var(--secondary)] py-10 border-t-2 flex flex-col items-center">
            <div className="">
                <h3 className="text-lg">Md. Mohaiminul Islam</h3>
                <p>Gazipur, Bangladesh</p>
                <p> mohaiminulislam321@gmail.com</p>
            ...
            <p className="text-center text-sm mt-16">All rights reserved by © Mohaiminul Islam </p>
        </footer>
    );
};
